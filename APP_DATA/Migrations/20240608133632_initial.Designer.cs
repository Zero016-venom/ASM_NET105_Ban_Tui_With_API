...
namespace APP_DATA.Migrations
{
    ...
    [Migration("20240608133632_initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("APP_DATA.Models.ApplicationRole", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("APP_DATA.Models.ApplicationUser", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("APP_DATA.Models.ChuongTrinhKhuyenMai", b =>
                {
            ...
            modelBuilder.Entity("APP_DATA.Models.PTTT", b =>
                {
                    b.Property<Guid>("ID_PTTT")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("APP_DATA.Models.GioHang", b =>
                {
                    b.HasOne("APP_DATA.Models.ApplicationUser", "User")
                        .WithOne("GioHang")
                        .HasForeignKey("APP_DATA.Models.GioHang", "ID_User")
            ...
            modelBuilder.Entity("APP_DATA.Models.HoaDon", b =>
                {
                    b.HasOne("APP_DATA.Models.PTTT", "PTTT")
                        .WithMany("HoaDons")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<System.Guid>", b =>
                {
                    b.HasOne("APP_DATA.Models.ApplicationRole", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<System.Guid>", b =>
                {
                    b.HasOne("APP_DATA.Models.ApplicationUser", null)
                        .WithMany()
